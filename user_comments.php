    ...
    ?>
        <section class="comment-edit-form">
            ...
            <form method="POST">
                ...
                <textarea name="comment_edit_box" cols="30" rows="10" placeholder="please enter your comment"><?= $fetch_edit_comment ?></textarea>
                <button type="submit" class="inline-btn" name="edit-comment">edit comment</button>
                <div class="inline-option-btn" onclick="window.location.href = 'user_comment.php';">cancel edit</div>
            </form>
        </section>
    <?php
    }
